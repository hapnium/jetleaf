...
import '../parsers/environment_parser_factory.dart';
import '../parsers/env_parser.dart';
...
/// ### Example
/// ```dart
/// final loader = EnvPropertySourceLoader('/config');
...
class EnvPropertySourceLoader extends PropertySourceLoader {
  ...
  EnvPropertySourceLoader(super.baseDirectory, super.baseName, super.loggerFactory);
  ...
  /// ## Example Usage
  /// ```dart
  /// final envResource = EnvPropertySourceLoader('/config', '', loggerFactory);
