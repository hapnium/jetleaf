...
/// ### Example
/// ```dart
/// final loader = JsonPropertySourceLoader('/config');
...
class JsonPropertySourceLoader extends PropertySourceLoader {
  ...
  final String LOG_PREFIX = 'JsonPropertySourceLoader';
  ...
  JsonPropertySourceLoader(super.baseDirectory, super.baseName, super.loggerFactory);
  ...
  /// ## Example Usage
  /// ```dart
  /// final envResource = JsonPropertySourceLoader('/config', 'application');
