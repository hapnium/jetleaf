...
/// ### Example
/// ```dart
/// final loader = YamlPropertySourceLoader('/config');
...
class YamlPropertySourceLoader extends PropertySourceLoader {
  ...
  final String LOG_PREFIX = 'YamlPropertySourceLoader';
  ...
  YamlPropertySourceLoader(super.baseDirectory, super.baseName, super.loggerFactory);
