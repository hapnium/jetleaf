...
class FileInputStream extends InputStream {
  ...
  Future<void> _ensureOpen() async {
    ...
    if (_randomAccessFile == null) {
      try {
        ...
        throw IOException('Cannot open file: ${_file.path}', e);
      }
    }
  }
  ...
  Future<int> readByte() async {
    ...
    try {
      ...
      throw IOException('Error reading from file: ${_file.path}', e);
    }
  }
  ...
  Future<int> skip(int n) async {
    ...
    try {
      ...
      throw IOException('Error skipping in file: ${_file.path}', e);
    }
  }
  ...
  Future<int> available() async {
    ...
    try {
      ...
      throw IOException('Error getting available bytes: ${_file.path}', e);
    }
  }
  ...
  Future<void> close() async {
    if (!isClosed) {
      try {
        ...
        throw IOException('Error closing file: ${_file.path}', e);
      } finally {
