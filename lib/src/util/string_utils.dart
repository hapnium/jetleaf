...
class StringUtils {
  ...
  /// Check if a string has text (not just whitespace)
  ...
  static List<String> commaDelimitedListToStringArray(String? str) {
    return delimitedListToStringArray(str, ',');
  }

  /// Convert comma delimited list to set
  static Set<String> commaDelimitedListToSet(String? str) {
    return commaDelimitedListToStringArray(str).toSet();
  }
