...
/// Example usage:
/// ```dart
/// throw BundlerException('Failed to load template', 'templates/home.html');
/// ```
/// {@endtemplate}
class BundlerException implements Exception {
  ...
  BundlerException(this.message, this.assetPath, [this.cause]);
  ...
  @override
  String toString() {
    final buffer = StringBuffer('BundlerException: $message');
