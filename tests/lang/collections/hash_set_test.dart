...
void main() {
  group('HashSet', () {
    ...
    test('first should work', () {
      ...
      expect(set.first, 1);
      expect(() => HashSet<int>().first, throwsStateError);
    });
    ...
    test('firstWhere should work', () {
      ...
      expect(() => set.firstWhere((e) => e > 10), throwsStateError);
    });
    ...
    test('last should work', () {
      final set = HashSet<int>()..add(1);
      expect(set.last, 1);
      expect(() => HashSet<int>().last, throwsStateError);
    });
    ...
    test('lastWhere should work', () {
      ...
      expect(() => set.lastWhere((e) => e > 10), throwsStateError);
    });
    ...
    test('reduce should work', () {
      ...
      expect(() => HashSet<int>().reduce((value, element) => value + element), throwsStateError);
    });
    ...
    test('single should work', () {
      ...
      expect(() => HashSet<int>().single, throwsStateError);
      expect(() => (HashSet<int>()..addAll([1, 2])).single, throwsStateError);
    });
    ...
    test('singleWhere should work', () {
      ...
      expect(() => set.singleWhere((e) => e > 0), throwsStateError); // More than one
      expect(() => set.singleWhere((e) => e == 4), throwsStateError); // No element
    });
