...
class FileReader extends Reader {
  ...
  /// ```dart
  /// final reader = FileReader('document.txt');
  /// final utf16Reader = FileReader('unicode.txt', encoding: utf16);
  /// ```
  /// 
  ...
  Future<void> _loadBuffer() async {
    try {
      ...
      throw IOException('Error reading file: ${_file.path}', e);
    }
  }
  ...
  /// ## Example
  /// ```dart
  /// final reader = FileReader('document.txt', encoding: utf16);
