...
void main() {
  group('LinkedList', () {
    ...
    test('firstWhere should work', () {
      ...
      expect(() => list.firstWhere((e) => e > 10), throwsStateError);
    });
    ...
    test('lastWhere should work', () {
      ...
      expect(() => list.lastWhere((e) => e > 10), throwsStateError);
    });
    ...
    test('reduce should work', () {
      ...
      expect(() => LinkedList<int>().reduce((value, element) => value + element), throwsStateError);
    });
    ...
    test('setRange should work', () {
      ...
      expect(() => list.setRange(0, 2, [1, 2, 3]), throwsArgumentError); // Iterable too long
    });
    ...
    test('singleWhere should work', () {
      ...
      expect(() => list.singleWhere((e) => e > 0), throwsStateError); // More than one
      expect(() => list.singleWhere((e) => e == 4), throwsStateError); // No element
    });
    ...
    test('first setter should work', () {
      ...
      expect(() => LinkedList<int>().first = 1, throwsStateError);
    });
    ...
    test('last setter should work', () {
      ...
      expect(() => LinkedList<int>().last = 1, throwsStateError);
    });
  });
}